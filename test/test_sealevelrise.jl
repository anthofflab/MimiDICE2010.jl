...
@testset "sealevelrise" begin
    ...
    update_param!(m, :sealevelrise, :therm0, p[:unshared][(:sealevelrise, :therm0)])
    update_param!(m, :sealevelrise, :gsic0, p[:unshared][(:sealevelrise, :gsic0)])
    update_param!(m, :sealevelrise, :gis0, p[:unshared][(:sealevelrise, :gis0)])
    update_param!(m, :sealevelrise, :ais0, p[:unshared][(:sealevelrise, :ais0)])
    update_param!(m, :sealevelrise, :therm_asym, p[:unshared][(:sealevelrise, :therm_asym)])
    update_param!(m, :sealevelrise, :gsic_asym, p[:unshared][(:sealevelrise, :gsic_asym)])
    update_param!(m, :sealevelrise, :gis_asym, p[:unshared][(:sealevelrise, :gis_asym)])
    update_param!(m, :sealevelrise, :ais_asym, p[:unshared][(:sealevelrise, :ais_asym)])
    update_param!(m, :sealevelrise, :thermrate, p[:unshared][(:sealevelrise, :thermrate)])
    update_param!(m, :sealevelrise, :gsicrate, p[:unshared][(:sealevelrise, :gsicrate)])
    update_param!(m, :sealevelrise, :gisrate, p[:unshared][(:sealevelrise, :gisrate)])
    update_param!(m, :sealevelrise, :aisrate, p[:unshared][(:sealevelrise, :aisrate)])
    update_param!(m, :sealevelrise, :slrthreshold, p[:unshared][(:sealevelrise, :slrthreshold)])
